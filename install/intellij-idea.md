...
IntelliJ IDEA est un éditeur de code très puissant édité par la société JetBrains. Il est excellent pour travailler avec le langage Java, avec laquelle tu travailleras en 1<sup>re</sup> année dans la section *Informatique* ou *Sciences de communication*.
